...
export const job24Sec = {
  ...
  videoDetails: {
    url: `http://localhost:3000/e.mp4`,
    startAt: 0
  },
  maxAllowedWorkersCount: 12
}

export const job24Sec1 = ({ duration = 24000, videoName = 'e.mp4', startAt = 0, endAt, fps = 24 }) => ({
  id: 'testJob',
  canvasObjects: [{
    id: 'test',
    x: 960,
  ...
  targetFps: 30,
  totalDuration: 33002, //parseInt(duration),
  resolution: {
    width: 1280,
    height: 720
  },
  videoDetails: {
    // url: `http://localhost:3000/slices/${videoName}`,
    url: `http://localhost:3000/e.mp4`,
    startAt: 0
  },
  maxAllowedWorkersCount: 2
})